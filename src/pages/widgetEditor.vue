    ...
    <div class="flex h-100vh">
        <div class="w-15rem h-100% flex flex-col">
            ...
            <VueDraggable v-model="availableList" :animation="150"
                ...
                <div v-for="item in availableList" :key="item.key" class="cursor-move bg-gray-500/5 rounded p-3">
                    {{ item.name }}
                </div>
            </VueDraggable>
        </div>
        <div class="w-15rem h-100% flex flex-col grow-1">
            ...
            <VueDraggable v-model="scheduleStore.widgets" :animation="150" group="people"
                class="flex flex-col gap-2 p-4 h-100% grow-1 overflow-auto">
